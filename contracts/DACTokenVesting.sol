...
*/
contract DACTokenVesting is TokenVesting {

  uint256 public divider;

  function DACTokenVesting(address _beneficiary, uint256 _start, uint256 _cliff, uint256 _duration, uint256 _divider, bool _revocable) TokenVesting(_beneficiary, _start, _cliff, _duration, _revocable) public   {
