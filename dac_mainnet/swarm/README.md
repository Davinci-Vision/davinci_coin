...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/davinciproject/davinci_coin/dac_mainnet

    go install github.com/davinciproject/davinci_coin/dac_mainnet/cmd/swarm
 ...
 * [Code review guidelines](https://github.com/davinciproject/davinci_coin/dac_mainnet/wiki/Code-Review-Guidelines).
